    ...
    m_GUIContainer()
{
    ...
    addButtonLabel(PlayerAction::MoveLeft, x, "Move Left", context);
    addButtonLabel(PlayerAction::MoveRight, x, "Move Right", context);
    addButtonLabel(PlayerAction::MoveUp, x, "Move Up", context);
    addButtonLabel(PlayerAction::MoveDown, x, "Move Down", context);
    addButtonLabel(PlayerAction::Fire, x, "Fire", context);
	addButtonLabel(PlayerAction::LaunchMissile, x, "Missile", context);
    }
