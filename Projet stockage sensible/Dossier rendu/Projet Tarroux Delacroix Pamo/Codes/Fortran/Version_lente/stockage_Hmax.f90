...
integer::Nc, Nb_iteration_espace, Pression
double precision::t_max, dt
double precision::largeur, debit_total
...
!**********************************************************************************************************************
call variable(Ray, L, L_entre_c, Nc, h_max, dt, t_max, Pression,&
	&T_entree, T_initial_C, largeur, debit_total, T_1 )
!************** Calcule du nombre d'itération nécéssaire pour la hauteur maximum  ****************
...
call cpu_time(t2)
print*,"temps CPU pour le calcul avec H_max=",t2-t1,'s'
...
!****************************************************************************************************
!****************************************************************************************************
subroutine variable(Ray, L, L_entre_c, Nc, h_max, dt, t_max, Pression,&
	&T_entree, T_initial_C, largeur, debit_total, T_1 )
implicit none
...
integer,intent(out)::Nc, Pression
