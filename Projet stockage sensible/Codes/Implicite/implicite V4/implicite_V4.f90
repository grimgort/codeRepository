...
!**********************************************************************************************************************
!********************* Boucles et autres **********************
integer::i,k,boucle_temps,ios,ios_fermeture,Compteur_do_while
...
DO WHILE(T_1((Nc+1)*Nb_iteration_espace)>T_arret)
	...
	print*,"Nb_iteration_espace=",Nb_iteration_espace
	...
	call Rajout_de_tube(T_1, T_arret, Nb_iteration_espace, augmentation_hauteur)
	print*,"augmentation_hauteur=",augmentation_hauteur
...
print*,"Nombre de cofalit sur la hauteur:"
print*,Nb_iteration_espace,"cofalits"
print*,
print*,"Repartition de la température sur le dernier élément"
