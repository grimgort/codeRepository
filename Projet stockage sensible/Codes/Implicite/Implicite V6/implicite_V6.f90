...
!*************debugage ( à rajouter dans le fichier variable)**************
Augmentation_tube_max=500
h_max=200
coef_correctif=0.3
!***********************************************
...
DO WHILE(T_1((Nc+1)*Nb_iteration_espace)>T_arret)
	...
	call ecriture(T_1,Nb_iteration_espace,Nc, Gradient)
...
!****************************************************************************************************
!****************************************************************************************************
subroutine ecriture(T_1,Nb_iteration_espace,Nc, Gradient)
implicit none
double precision, dimension(:), intent(in) :: T_1
...
augmentation_hauteur=abs( ceiling( (T_arret - T_1((Nc+1)*Nb_iteration_espace) )/gradient*coef_correctif ) )
